...
var ePrivacy = function () {
	...
	function init(obj) {
		...
		template = '<div id="' + config.containerID + '" style="' + config.css.container + '">' +
			'<div class="container">' +
			' <div class="row">' +
			'   <div class="col-sm-12">' +
			//'     <div class="pull-right">' +
			'       <span class="glyphicon glyphicon-remove pull-right" aria-hidden="true" style="' + config.css.close + '"></span>' +
			//'     </div>' +
			'     <p class="mb-0" style="' + config.css.content + '">' + config.description + '</p> ' +
			'   </div>' +
			' </div>' +
			'</div>' +
			'</div>';
