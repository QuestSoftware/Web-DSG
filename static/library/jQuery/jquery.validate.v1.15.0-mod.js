		...
		defaults: {
			...
			onfocusout: function (element) {
				if (!this.checkable(element) && ( element.name in this.submitted || !this.optional(element) )) {
					//Modified by Edward Chong
					//Add delay becase we have conflict with jQuery Masked Plugin.
					var obj = this;
		...
		prototype: {
			...
			elementValue: function (element) {
				...
				if (element.hasAttribute("contenteditable")) {
					...
					//Modified by Edward Chong
					//Sometimes val() doesn't retrieve the right value.
					//val = $element.val();
					val = element.value;
				}
			...
			check: function (element) {
				...
				var rules = $(element).rules(),
					...
					//Modified by Edward. Remove spaces before/after value
...
// Use a prefilter if available (1.5+)
	...
	/**
	 * Matches US/CA (United States/Canada) phone number format
	 *
	...
	/**
	 * Matches AU (Australia) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches CN (China) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches IN (India) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches MY (Malaysia) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches NZ (New Zealand) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches SG (Singapore) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches KR (South Korea) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches PH (Philippines) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches HK (Hong Kong) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches TW (Taiwan) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches TH (Thailand) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
	...
	/**
	 * Matches VN (Vietnam) phone number format
	 *
	 * where the area code may not start with 1 and the prefix may not start with 1
	 * allows '-' or ' ' as a separator and allows parens around area code
	 *
