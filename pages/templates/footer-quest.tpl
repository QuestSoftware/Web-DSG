<footer id="footer">
	<div class="footer-top-section">
		<ul class="menu-links list-unstyled container">
			<li class="subLinks">
				<span>Company <i class="menu-indicator pull-right"></i></span>
				<ul>
					<li><a href="/company/">About Quest</a></li>
			...
			<li class="subLinks">
				...
				<ul>
					<li><a href="http://en.community.dell.com/techcenter/" target="_blank">Customer Stories</a></li>
            ...
            <span>
              <span id="current-country" class="flag-us">United States<i class="glyphicon glyphicon-triangle-bottom"></i></span>
            </span>
	...
	<div class="container footer-copyright-section">
		<ul class="menu-links list-inline row">
			<li><span>©2016 Quest Software Inc. ALL RIGHTS RESERVED.</span></li>
