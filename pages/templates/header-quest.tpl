				...
				<ul class="utility">
					...
					<li id="signin-container" class="dropdown">
						<a id="signin-link" data-target="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<span class="top-user-icon">
								<i class="glyphicon glyphicon-user">
									<span class="badge is-logged-in"><i class="glyphicon glyphicon-ok"></i></span>
								</i>
							</span>
						</a>
...
<script type="application/ld+json">
{
  ...
  "logo": "http://www.quest.com/images/shared/logo-blue.png",
  "sameAs" : [
    "http://www.facebook.com/dellsoftware",
    "https://plus.google.com/u/0/103474799682341904292/posts",
    "http://www.linkedin.com/groups/Dell-Software-4793472?gid=4793472&mostPopular=&trk=tyah",
    "http://twitter.com/dellsoftware"
  ]
}
...
<script type="application/ld+json">
{
  ...
  "potentialAction": {
    "@type": "SearchAction",
    "target": "http://www.quest.com/search/results/?q={search_term_string}",
    "query-input": "required name=search_term_string"
  }
}

</script>
<link rel="stylesheet" href="/static/css/bootstrap-quest.min.css">
<!--[if IE]>
<link rel="stylesheet" href="/static/css/bootstrap-ie.min.css"><![endif]-->
<link rel="stylesheet" href="/static/css/quest.min.css">
<link rel="stylesheet" href="/static/css/jquery-ui-1.11.4.min.css">

<script src="/static/library/jQuery/jquery.cookie.min.js"></script>
...
<script src="/static/js/responsive-header-footer-quest.min.js"></script>
...
<script src="/static/library/jQueryUI/jquery-ui-1.11.4.min.js"></script>
<!--<script src="/static/library/jquery/jquery.validate-mod.min.js?a"></script>-->
<!--<script type="text/javascript" src="/Static/Scripts/jquery.plugins.min.js"></script>-->
...
<ul class="tier1">
	<li>
		...
		<ul class="tier2">
			<li class="subLinks">
				<a href="#">
					<span>Por línea de productos </span>
					<i class="menu-indicator pull-right"></i>
				</a>
				<ul class="tier3">
					<li><a href="/mx-es/kace/">Kace</a></li>
					<li><a href="/mx-es/remotescan/">RemoteScan</a></li>
					<li><a href="/mx-es/sonicwall/">SonicWALL</a></li>
				</ul>
			</li>
			<li>
				<a href="/mx-es/products/">
	...
	<li>
		...
		<a target="_blank" href="/mx-es/solutions/">
          <span>
       Soluciones
          </span>
			<i class="menu-indicator pull-right"></i>
		...
		<ul class="tier2">
			<li>
				<a href="/mx-es/solutions/cloud-management/">
					<span>Administración de los servicios en la nube</span>
				</a>
			</li>
			<li>
				<a href="/mx-es/solutions/endpoint-systems-management/">
					<span>Administración de Sistemas Endpoint</span>
				</a>
			</li>
			<li>
				<a href="/mx-es/solutions/advanced-analytics/">
					<span>Análisis avanzado</span>
				</a>
			</li>
			<li>
				<a href="/mx-es/solutions/data-protection/ ">
					<span>Protección de datos</span>
				</a>
			</li>
			<li>
				<a href="/mx-es/database-management/">
					<span>Gerenciamiento de Base de Datos</span>
				</a>
			</li>
			<li>
				<a href="/mx-es/solutions/microsoft-platform-management/">
					<span>Gerenciamiento de Plataformas Microsoft</span>
				</a>
			</li>
			<li>
				<a href="/mx-es/solutions/performance-monitoring/">
					<span>Monitoreo de Performance</span>
				</a>
			</li>

			<li>
				<a href="/mx-es/solutions/">
					<span>Conozca todas las soluciones</span>
				</a>
			</li>
		</ul>
	...
	<li>
		<a href="/mx-es/trials/">Versiones de prueba</a>
	</li>
	<li>
		<a href="/mx-es/buy/">Comprar</a>
	</li>
	<li>
		<a href="http://support.software.dell.com/es-es">Soporte</a>
	</li>
	<li>
		<a href="http://en.community.dell.com/techcenter/" target="_blank">Comunidades</a>
	</li>
	<li>
		<a target="_blank" href="http://software.dell.com/mx-es/partners/">Socios</a>
	</li>
</ul>


<!--Spanish V2LayoutHeader -->
	...
	<div class="utility-section-wrapper blue">
		<div class="utility-section">
			...
			<div id="masthead-search" class="search-container">
				<form id="search-form">
					<input id="searchterm" type="text" class="search-query form-control"
					       placeholder="¿Qué está buscando?" ¿Podemos ayudarlo?"/>
					<button class="btn btn-primary">
						<span class="hidden-xs">Búsqueda</span>
			...
			<ul class="utility">
				...
				<li id="signin-container" class="dropdown">
					<a id="signin-link" data-target="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<span class="hidden-xs hidden-sm" id="sign-in"><span id="signin-button">Iniciar sesión</span></span>
					</a>

					<div role="menu" aria-labelledby="signin-link" class="dropdown-menu">
						<div class="col-xs-12">
							<h5 class="is-logged-in">
								<a href="#" id="lnkMyAccount">Mi cuenta</a>
							</h5>

							<div class="row">
								<div class="col-xs-12 not-logged-in">
									<button role="button"
									        class="btn btn-primary btn-block bottom-offset-mini top-offset-small lnk-sign-in">Iniciar
										sesión
									</button>
									<button role="button" class="btn btn-block btn-default lnk-create-account">Crear una cuenta</button>
								</div>
								<div class="col-xs-12 is-logged-in">
									<button id="lnkmainloggOut" role="button"
									        class="btn btn-default btn-block bottom-offset-mini top-offset-small">Cerrar sesión
									</button>
								</div>
							</div>
						</div>
